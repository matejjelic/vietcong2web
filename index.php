...
//			<br/><br/><p>Kind Regards,</p>"
//                    . "<br/>Matej J. (Site Admin)";
//            $mail = new Mail();
...
//            $mail->body($body);
//            $mail->send();
            // Commented code above does not work - no body in email - probably contet type issue...
            $message = "Thank you for registering at Vietcong 2 Web site." . "\n\n"
                    . "To activate your account, please click on this link: " . DIR . "activate.php?x=$id&y=$activasion" . "\n\n\n"
                    . "Kind Regards,\n"
                    . "Matej J. (Site Admin)";
            $email_from = 'Vietcong 2 Web<' . $SITEEMAIL . '>';
